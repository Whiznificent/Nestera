      ...
      {actions.map((a) => {
        ...
        return (
          <Button
              ...
              variant="ghost"
              size="md"
              className="flex flex-col items-center justify-center p-[18px] h-[110px] rounded-2xl bg-linear-to-b from-[rgba(6,18,20,0.52)] to-[rgba(4,14,16,0.4)] border border-[rgba(12,120,120,0.08)] text-[#e6ffff] transition-all duration-120 ease-in-out hover:-translate-y-1.5 hover:shadow-[0_14px_34px_rgba(2,28,28,0.6)]"
          >
